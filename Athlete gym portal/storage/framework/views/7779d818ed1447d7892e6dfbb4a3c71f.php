        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <?php             
                        $blogImgUrl =  url($blog->blogImg);
                    ?>
                    <form action="/edit-blog/<?php echo e($blog->id); ?>" method="POST" id="editBlogForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <input id="blogTitle" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="blogTitle" value="<?php echo e($blog->blogTitle); ?>" required/>
                        </div>
                        ...
                        <div class="mt-10">
                            ...
                            <p class="mt-2 fw-bold">Previous Blog Image</p>
                            <img src=' <?php echo e(url($blog->blogImg)); ?> ' alt="Blog Image" id="imgPreview" class="img img-rounded img-fluid  rounded-2" />
                        ...
                        <div class="mt-10">
                            ...
                            <textarea id="blogDescription" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="blogDescription" rows="20"  required><?php echo e($blog->blogDescription); ?></textarea>
                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\gbrls\Documents\Gym Portal Dec 2024\Athlete gym portal\resources\views/guest/edit-blog.blade.php ENDPATH**/ ?>