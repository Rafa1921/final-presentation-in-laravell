...
<?php endif; ?>
        ...
        <h2 class="flex items-center justify-center mb-6 mt-6 font-semibold text-xl text-gray-800 leading-tight">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'ms-4 mt-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-4 mt-6']); ?>
                    <?php echo e(__('Register')); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-center mt-4">
                ...
                <a class="underline ml-4 text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="/login">
                    <?php echo e(__('Login')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\gbrls\Documents\Gym Portal Dec 2024\Athlete gym portal\resources\views/auth/register.blade.php ENDPATH**/ ?>