        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    ?>
                    <form action="/edit-blog/{{$blog->id}}" method="POST" id="editBlogForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input id="blogTitle" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="blogTitle" value="{{$blog->blogTitle}}" required/>
                        </div>
                        ...
                        <div class="mt-10">
                            ...
                            <img src=' {{url($blog->blogImg)}} ' alt="Blog Image" id="imgPreview" class="img img-rounded img-fluid  rounded-2" />
                        ...
                        <div class="mt-10">
                            ...
                            <textarea id="blogDescription" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="blogDescription" rows="20"  required>{{$blog->blogDescription}}</textarea>
                        </div>
